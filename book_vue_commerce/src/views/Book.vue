  ...
  <section class="mt-32 mb-12 container mx-auto px-4 flex justify-center flex-col md:flex-row">
    ...
    <div class="ml-5 md:ml-20 w-full md:w-1/2">
      ...
      <div class="flex flex-row mt-4">
        ...
        <button v-if="product.stock" class="shadow focus:outline-none rounded px-2 bg-yellow-500 hover:bg-yellow-600 ml-1 text-white w-1/3"> <i class="fas fa-shopping-cart"></i> ADD TO CART</button>
