<template lang="html">
  <section class="mt-28 container mx-auto px-8 mb-10">
    <div class="flex justify-center">
      <div class="w-full max-w-lg mt-10">
        <h1 class="text-3xl font-bold text-yellow-600 border-b-2 border-yellow-600 pb-2"><i class="fas fa-door-open"></i> Sign Up</h1>
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          ...
          <div class="w-full md:w-1/2 px-3">
            ...
            <input v-model="form.password_confirmation" :class="[errors.password_confirmation ? 'border-red-600' : 'border-yellow-600']" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="password" placeholder="Confirm your password">
        ...
        <div class="mt-4 text-sm text-gray-600">
          <i class="fas fa-exclamation-circle"></i> Have already an account ? <span class="text-yellow-600"><router-link :to="{ name: '', params: {} }">Sign In here</router-link></span>
        </div>
      </div>
    </div>
  </section>
